      ...
      <div class="properties">
              ...
              <ul class="list_agents">
                <li>
                  <div class="our-border clearfix">
                    ...
                    <div class="our-img"><img src="../site/img/imgdemo/180x180.gif" alt=""></div>
        ...
        <div class="container">
          ...
          <div class="agentsproperties">
              <h3>Agent’s Properties</h3>
            <div class="row">

              <ul id="able-list" class="products">

                <li class="span4 first house offices Residential" style="display: block;">

                  <div class="product-item">

                    <div class="imagewrapper">

                      <img width="300" height="180" src="../site/img/imgdemo/300x180.gif" alt="">

                      <span class="price"> $358.000</span>

                    </div>

                    <h3><a title="" href="../site/property_detail.php"> 1076 Nelson Walk </a></h3>
                ...
                <li class="span4 house offices apartment Residential">
                  ...
                  <div class="product-item">
                    ...
                    <h3><a title="" href="../site/property_detail.php"> 4101 Gulf Shore </a></h3>
                ...
                <li class="span4 product last house offices apartment">
                  ...
                  <div class="product-item">
                    ...
                    <h3><a title="" href="../site/property_detail.php"> 3900 Rum Row</a></h3>
                ...
                <li class="span4 product first offices apartment Residential">
                  ...
                  <div class="product-item">
                    ...
                    <h3><a title="" href="../site/property_detail.php"> 1085 Nelsons Walk </a></h3>
                ...
                <li class="span4 house offices apartment Residential">
                  ...
                  <div class="product-item">
                    ...
                    <h3><a title="" href="../site/property_detail.php"> 3675 Gordon Dr </a></h3>
                ...
                <li class="span4 product last house offices Residential">
                  ...
                  <div class="product-item">
                    ...
                    <h3><a title="" href="../site/property_detail.php"> 204 temporibus vis  </a></h3>
            ...
            <div class="page-ination onleft">
              ...
              <div class="page-in">
                ...
                <ul class="clearfix">
                  ...
                  <li><a href="#"><img src="../site/img/icon/pre2.png" alt=""></a></li>

                  <li><a href="#"><img src="../site/img/icon/pre1.png" alt=""></a></li>
                  ...
                  <li><a href="#"><img src="../site/img/icon/next1.png" alt=""></a></li>

                  <li><a href="#"><img src="../site/img/icon/next2.png" alt=""></a></li>
