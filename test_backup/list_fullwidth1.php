            ...
            <div class="span6">
              <div class="list-grid inleft">
                <ul>
                  ...
                  <li><a href="../site/grid_fullwidth_3_column.php"><i class="grid3col"></i></a></li>
                  <li><a class="active" href="../test1/list_fullwidth2.html"><i class="grid2list"></i></a></li>
                </ul>
              </div>
            </div>
            <div class="span6">
                  ...
                  <div class="row">
                    ...
                    <div class="span8">
                      <div class="list-right-info">
                        <div class="row">
                          <div class="span4">
                            <h3><a href="#" title=""> 1076 Nelson Walk </a></h3>
                            <p>
                              Etiam at ante id enim dictum posuere id vel est. Praesent at massa quis risus cursus tristique vel non orci. Phasellus ut nisi non odio
                            </p>
                          </div>
                          <div class="span4">
                            <ul class="title-info">
