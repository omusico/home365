            ...
            <div class="span6">
              <div class="list-grid inleft">
                <ul>
                  ...
                  <li><a class="active" href="grid_fullwidth_3_column.php"><i class="grid3col"></i></a></li>
                  <li><a href="list_fullwidth1.php"><i class="grid2list"></i></a></li>
                </ul>
              </div>
            </div>
            <div class="span6">
          ...
          <ul class="products" id="able-list">
            <li style="display: block;" class="span4 first house offices Residential">
              <div class="product-item">
                ...
                <h3><a href="property_detail.php" title=""> 1076 Nelson Walk </a></h3>
                <ul class="title-info">
            ...
            <li class="span4 house offices apartment Residential">
              <div class="product-item">
                ...
                <h3><a href="property_detail.php" title=""> 4101 Gulf Shore </a></h3>
                <ul class="title-info">
                  <li>Bathrooms <span> 1</span> </li>
                  <li>Bathrooms <span> 1</span></li>
                  <li>Square Footage <span>3200 sqft</span></li>
            ...
            <li class="span4 product last house offices apartment">
              <div class="product-item">
                ...
                <h3><a href="property_detail.php" title=""> 3900 Rum Row</a></h3>
                <ul class="title-info">
                  <li>Bathrooms <span> 1</span> </li>
                  <li>Bathrooms <span> 1</span></li>
                  <li>Square Footage <span>3200 sqft</span></li>
            ...
            <li class="span4 product first offices apartment Residential">
              <div class="product-item">
                ...
                <h3><a href="property_detail.php" title=""> 1085 Nelsons Walk </a></h3>
                <ul class="title-info">
                  <li>Bathrooms <span> 1</span> </li>
                  <li>Bathrooms <span> 1</span></li>
                  <li>Square Footage <span>3200 sqft</span></li>
            ...
            <li class="span4 house offices apartment Residential">
              <div class="product-item">
                ...
                <h3><a href="property_detail.php" title=""> 3675 Gordon Dr </a></h3>
                <ul class="title-info">
                  <li>Bathrooms <span> 1</span> </li>
                  <li>Bathrooms <span> 1</span></li>
                  <li>Square Footage <span>3200 sqft</span></li>
            ...
            <li class="span4 product last house offices Residential">
              <div class="product-item">
                ...
                <h3><a href="property_detail.php" title=""> 204 temporibus vis  </a></h3>
                <ul class="title-info">
                  <li>Bathrooms <span> 1</span> </li>
                  <li>Bathrooms <span> 1</span></li>
                  <li>Square Footage <span>3200 sqft</span></li>
